...
urlpatterns = [
    ...
    url(r'^signup-success/$',
        ...
        name='signup-success'),
    url(r'^login/$', auth_views.LoginView.as_view(template_name='mgmembers/login.html'),
        name='login'),
    url(r'^logout/$', auth_views.LogoutView.as_view(template_name='mgmembers/logout.html'),
        name='logout'),
    ...
    url(r'^dynamis/plan/(?P<pk>\d+)/?$',
        mgviews.DynamisPlanUpdateView.as_view(),
        name='dynamis-plan-edit'),
    url(r'^dynamis/plan/create/?$',
        mgviews.DynamisPlanUpdateView.as_view(),
        name='dynamis-plan-create'),
    url(r'^about/?$',
